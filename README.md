...
IF you would like to use the intensity field from the lidar unint then run Velodyne_tls_intensity instead of main_demo. You will need to adjust your a1 a2 r and time values to your setup. 
